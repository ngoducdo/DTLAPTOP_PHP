...
class AdminController extends Controller
{
    public  function getIndex(){
        ...
        $bill_admin = Bill::orderBy('id','desc')->paginate(7);
        $user = User::all();
        $supplier = Supplier::all();
    	return view('admin.layout.trangchu',compact('customer','sanpham','user','supplier','loaisp','danhmuc','bill','bill1','bill2','bill3','bill_admin'));
    }
