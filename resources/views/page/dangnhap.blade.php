    ...
    margin: auto; height: 500px; margin-top: 20px;">
					...
					@endif
							...
							<div class="form-group has-feedback has-feedback-left">
								<label class="">Tài khoản Email</label>
								<input type="email" name="email" class="form-control" placeholder="Nhập tên đăng nhập">
					...
					<div class="footer text-muted text-center">
						&copy; 2020. <a href="#">Limitless Web App Kit</a> by <a href="http://themeforest.net/user/Kopyov" target="_blank">Eugene Kopyov</a>
					</div>
					<!-- /footer -->
