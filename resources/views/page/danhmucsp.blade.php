...
<div class="breadcrumb-area">
            ...
            <div class="content-wraper pt-60 pb-60" style="padding-top: 10px !important;">
                <div class="container">
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <div class="shop-top-bar mt-30">
                                <div class="shop-bar-inner">
                                    ...
                                    <div class="toolbar-amount">
                                        <span>Tổng có {{count($sp_loai)}} sản phẩm</span>
                                    </div>
                                </div>
                                ...
                                <div class="tab-content">
                                    <div id="grid-view" class="tab-pane fade active show" role="tabpanel">
                                        <div class="product-area shop-product-area">
                                            	<div class="row">
                                                    @if(count($sp_loai) == 0)
                                                        <div style="margin-left: 15px; background: #faebcc"><span style="padding: 5px 0">Không có sản phẩm nào trong danh mục này</span></div>
                                                    @else
                                                        ...
                                                        <div class="single-product-wrap">
                                                            ...
                                                            <div class="product_desc">
                                                                <div class="product_desc_info">
                                                                    ...
                                                                    <h4><a class="product_name" href="{{route('chitietsanpham',$spl->id)}}"><?php echo substr($spl['name'],0,50) ?></a></h4>
                                                                    <div class="price-box">
                                                                        @if($spl->promotion_price==0)
