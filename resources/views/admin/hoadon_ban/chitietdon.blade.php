  ...
  <div class="container-fluid">
  	<div class="row">
        ...
        <table class="table m-auto">
          ...
          <tr>
           @foreach($bill_detail as $test)
              <td colspan="2"><p>Ngày hết hạn bảo hành:</p><h4 id="sdt">{{$test->expire}}</h4></td>
             @endforeach
          </tr>
        ...
        <table class="table table-bordered">
          <h4>Danh sách sản phẩm đã mua</h4>
            ...
            <br>
            <button class="print-bill btn btn-success" onclick="window.print()"><i class="fa fa-print"></i> In hóa đơn</button>
    </div>
  </div>
</div>
