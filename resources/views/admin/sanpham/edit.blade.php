            ...
            <div class="col-md-6">
                ...
                <div class="form-group">
                  ...
                  <select class="form-control" name="ncc" id="ncc">
                    @foreach($nhacc1 as $ncc)
                      <option 
                      @if($product->id_ncc == $ncc->id)
                      {{"selected"}}
                      @endif
                ...
                <div class="form-group">
                  ...
                  <textarea id="demo" class="form-control ckeditor" name="des1" rows="3" placeholder="Mô tả" >{{$product->description1}}</textarea>
                </div>
                  </div> 
              <div class="col-md-4">
                <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <select class="form-control" name="guarantee">
                    ...
                    <option value="12" @if($product->guarantee == 18) {{"selected"}} @endif /> 18 tháng</option>
                    <option value="24" @if($product->guarantee == 24) {{"selected"}} @endif /> 24 tháng</option>
                    <option value="36" @if($product->guarantee == 36) {{"selected"}} @endif /> 36 tháng</option>
                  </select>
                </div>
                <div class="form-group">
                  <label>giá gốc</label>
                ...
                <div class="form-group">
                 ...
                 <select class="form-control" name="new">
                    ...
                    <option value="2" @if($product->new == 2) {{"selected"}} @endif /> Khuyến mại</option>
                  </select>
                </div>
